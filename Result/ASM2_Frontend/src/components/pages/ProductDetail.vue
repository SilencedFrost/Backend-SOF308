...
const relatedProducts = ref([
  {
    name: 'iPad Mini',
    image:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSdyS9F7cKkQyeX5j6KRJz2ca0sy0oYqwN1eQ&s',
    price: '8.000.000 VNĐ',
    rating: 4.5,
    likes: 120,
  },
  {
    name: 'iPad Air',
    image:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRUPWLDInX1gQaig1pjcxKGggVD0e33xZvDzg&s',
  ...
  },
  {
    name: 'iPad Pro',
    image:
      'https://traidepbaniphone.com/thumbs/760x540x2/upload/product/ipadpro11-inwi-fispacegray2-upscreenusen-1035.png',
...
const comments = ref([
  ...
  {
    user: 'Trần Thị B',
    text: 'Giá hơi cao nhưng chất lượng tuyệt vời.',
    rating: 4,
  },
  ...
  {
    user: 'Nguyễn Viết T',
    text: 'Sản phẩm đẹp nhưng chạy chưa được mượt.',
    rating: 4,
  },
])

            ...
            <h4 class="mb-4 fw-bold text-primary">
              ...
              <div class="row mt-4">
                <div class="col-12 text-center">
                  ...
                  <button class="btn btn-outline-secondary mb-2 rounded-pill px-4" @click="changePassword">
...
export default {
  ...
  data() {
    return {
      ...
      defaultAvatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=120&h=120&fit=crop&crop=face'
    }
  },
  methods: {
